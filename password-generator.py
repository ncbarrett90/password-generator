...
numbers = tk.StringVar(value="2")
specials = tk.StringVar(value="2")
...
length_spinbox = tk.Spinbox(length_frame, from_=4, to=50, textvariable=length, width=5)
...
numbers_spinbox = tk.Spinbox(numbers_frame, from_=0, to=20, textvariable=numbers, width=5)
...
specials_spinbox = tk.Spinbox(specials_frame, from_=0, to=20, textvariable=specials, width=5)
